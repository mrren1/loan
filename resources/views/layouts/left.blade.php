    ...
    <p class="say-hi ng-binding">{{Session::get('user_name')}}</p>
          ...
          <section class="summary-nav-body"> 
           ...
           <ul class="nav nav-list"> 
            ...
            <li class="change3"><a href='member_tuan'><span class="sl-icon-agreement"></span>团团赚</a> </li> 
            <li class="change4" ng-class="{active:isTabActive('invest-history')}"> <a href='member_bid_record'><span class="sl-icon-details-more"></span>投标记录</a> </li> 
