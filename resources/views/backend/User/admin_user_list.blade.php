...
function user_stop(obj,id){
	...
	layer.confirm('确认要停用吗？',function( index ){
		$.ajax({
			type: 'GET',
			url: 'admin_user_stop?id='+id,
			dataType: 'json',
			success: function(data){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="user_start(this,id)" href="javascript:;" title="白名单"><i class="Hui-iconfont">&#xe6e1;</i></a>');
...
function user_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		$.ajax({
			type: 'GET',
			url: 'admin_user_start?id='+id,
			dataType: 'json',
			success: function(data){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="user_stop(this,id)" href="javascript:;" title="黑名单"><i class="Hui-iconfont">&#xe631;</i></a>');
				$(obj).parents("tr").find(".td-status").html('<span class="label label-success radius">白名单</span>');
				$(obj).remove();
